...
6. **Score** (`scoring.py`): sum of severity weights (cap 100) → risk level. A synthesized
   *critical* finding is added when filesystem and network capabilities co-occur.
